...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string UserAdded = UserText + Added;
        public static string UserDeleted = UserText + Deleted;
        public static string UserUpdated = UserText + Updated;
        public static string UserListed = UserText + Listed;
        public static string UserById = UserText + ById;
        public static string UserRegistered = UserText + Registered;

        public static string UserNotFound = UserText + NotFound;
        public static string UserAlReadyExists = UserText + AlReadyExists;
